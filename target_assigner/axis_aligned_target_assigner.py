...
class AxisAlignedTargetAssigner(object):
    def __init__(self, class_names, box_coder, anchor_generator_cfg, match_height=False):
        super().__init__()
        ...
        self.sample_size = 512 #anchor_target_cfg.SAMPLE_SIZE
        self.norm_by_num_examples = False #anchor_target_cfg.NORM_BY_NUM_EXAMPLES
